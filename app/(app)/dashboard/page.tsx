      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Link href="/liga/nueva">
            <Button fullWidth variant="primary">+ Crear liguilla</Button>
          </Link>
          <Link href="/liga/unirse">
            <Button fullWidth variant="secondary">Unirse con código</Button>
          </Link>
        </div>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <h2 className="text-white font-bold truncate">{pool.name}</h2>
                      ...
                      <span className={`text-xs font-medium ${POOL_STATUS_COLOR[pool.status]}`}>

...
export const SCORING_RULES_DEFAULTS: Pick<ScoringRule, 'code' | 'name' | 'description'>[] = [
  { code: 'winner',     name: 'Ganador correcto',       description: 'Acertar quién gana o si hay empate'                  },
  { code: 'home_goals', name: 'Goles local exacto',     description: 'Acertar los goles del equipo local'                  },
  { code: 'away_goals', name: 'Goles visitante exacto', description: 'Acertar los goles del equipo visitante'              },
  { code: 'goal_diff',  name: 'Diferencia de goles',    description: 'Acertar la diferencia de goles entre ambos equipos'  },
  { code: 'exact',      name: 'Marcador exacto',        description: 'Bonus por acertar ambos goles exactamente'           },
]

...
export default function PredictionModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-sm bg-gray-900 border border-gray-800 rounded-t-2xl sm:rounded-2xl p-6 mx-auto mb-16 sm:mb-0">
        {/* Header */}
...
function ScoreInput({
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      <span className="text-white text-2xl font-bold tabular-nums w-8 text-center">
        {value}
      </span>
      <button
